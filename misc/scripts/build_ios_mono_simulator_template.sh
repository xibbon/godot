...
OUT_DIR="$ROOT_DIR/DEVEL/ios-debug-simulator"
BUILD_DIR=""
APP_NAME="game"
DISPLAY_NAME="Game"
...
Build a maximal-debug iOS *simulator* template with GDMono, then package:
  - game.app
  - ios_template.zip, containing game.app
  - ios.zip, the Godot iOS Xcode export template zip

Options:
  --out-dir PATH       Output directory. Default: DEVEL/ios-debug-simulator
...
DEBUG_TEMPLATE_LIB="$STAGE_DIR/libgodot.ios.debug.xcframework/ios-arm64_x86_64-simulator/libgodot.a"
RELEASE_TEMPLATE_DEVICE_DIR="$STAGE_DIR/libgodot.ios.release.xcframework/ios-arm64_x86_64-simulator"
...
xcodebuild \
	...
	CONFIGURATION_BUILD_DIR="$XCODE_BUILD_DIR/Debug-iphonesimulator" \
...
APP_BUNDLE="$XCODE_BUILD_DIR/Debug-iphonesimulator/$APP_NAME.app"
