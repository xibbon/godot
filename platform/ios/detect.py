...
def configure(env: "SConsEnvironment"):
    ...
    # Metal is supported on iOS Simulator (iOS 13+), so we no longer disable it.
    # Simulator-specific limitations are handled with IOS_SIMULATOR guards in the Metal driver.
